...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Olá, mundo!", None))
        self.dial.setToolTip(_translate("MainWindow", "Esse componente não funciona", None))
        self.dial.setStatusTip(_translate("MainWindow", "Apareci na barra de status!!!", None))
